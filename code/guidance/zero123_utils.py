...
class Zero123(nn.Module):
    def __init__(self, device, fp16=True, t_range=[0.02, 0.98], model_key="ashawkey/zero123-xl-diffusers"):
        ...
        # Use LoRA zero123, 251027, bsk, doesn't work due to dimension mismatch
        # sys.path.append('/data/project/bumsoo/ifusion/')
        # from ldm.lora import inject_trainable_lora_extended
        # target_replace_module = ["CrossAttention", "GEGLU"]
        # rank = 12
        # ckpt_fp = '/data/project/bumsoo/shadow_art/dataset/imagine_shadow_art_test_11/transparent/lora.ckpt'
